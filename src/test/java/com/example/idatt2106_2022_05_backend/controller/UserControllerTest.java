...
public class UserControllerTest {
    ...
    private static Stream<Arguments> provideValidEmails() {
        return Stream.of(Arguments.of("test123@mail.com"), Arguments.of("test1.testesen@mail.com"),
    ...
    private static Stream<Arguments> provideInvalidEmails() {
        return Stream.of(Arguments.of("test123.no"), Arguments.of("test@"), Arguments.of("test@mail..com"));
    }
    ...
    public void testGetUserByUserId() throws Exception {
        ...
        mockMvc.perform(
                get(URI + "/" + testUser.getId().toString()).contentType(MediaType.APPLICATION_JSON).with(csrf()))
                .andExpect(status().isOk()).andExpect(jsonPath("$.firstName").value(testUser.getFirstName()));
    }
    ...
    public void testGetUserByUserIdReturnsResponseIncludingFollowerCount() throws Exception {
        ...
        mockMvc.perform(get(URI + "/" + testUser.getId().toString()).contentType(MediaType.APPLICATION_JSON))
