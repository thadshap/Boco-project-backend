...
//    private TokenFactory tokenFactory;
    ...
    void setUp() throws Exception {
        ...
        forgotDto = UserForgotPasswordDto.builder()
                .email("KenRobin@mail.com")
                .build();
...
//                .andExpect(status().isOk());
    ...
    void passwordRenewalFailed() throws Exception {
        ...
        forgotDto = UserForgotPasswordDto.builder().email("andetel@stud.ntnu.no")
                .build();
        String token = mvc.perform(post("/auth/forgotPassword")
                        .contentType(MediaType.APPLICATION_JSON)
...
//
//		UserRegistrationDto invalidUser = new UserRegistrationDto(firstName, lastName, password, "test@testersen.com", email);
//
//		mockMvc.perform(post(URI)
//			.with(csrf())
//			.contentType(MediaType.APPLICATION_JSON)
