...
public class ReviewServiceImpl implements ReviewService{
    ...
    private void getAllReviewOnAd(long ad_id){
    ...
    public List<ReviewDto> getReviewsByUserId(long id){
        ...
        return reviewRepository.getAllByUser(user).stream().map(review -> modelMapper.map(review, ReviewDto.class)).collect(Collectors.toList());
    }
}
