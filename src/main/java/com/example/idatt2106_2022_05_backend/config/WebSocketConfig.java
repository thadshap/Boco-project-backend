...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ...
        registry.addEndpoint("/ws").setAllowedOrigins("https://localhost:8080","chrome-extension://fnlgpklmfclcogcmiioamkhdnflfmnmp/", "chrome-extension://ggnhohnkfcpcanfekomdkjffnfcjnjam/").withSockJS();
    }
