...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws IOException {
        ...
        User user6 = User.builder().numberOfReviews(3).rating(6).firstName("Karoline").lastName("Wahl")
                ...
                .build();
        User user7 = User.builder().numberOfReviews(0).rating(1).firstName("Eirin").lastName("Svinsås")
        ...
        Category instruments = Category.builder().name("Instrumenter").parent(true).level(1).icon("fas fa-guitar")
                .build();
        Category clothing = Category.builder().name("Klær og tilbehør").parent(true).level(1).icon("fas fa-tshirt")
                .build();
        Category hobby = Category.builder().name("Hobby og fritid").parent(true).level(1).icon("fas fa-running")
                .build();
        Category garden = Category.builder().name("Hage, oppussing og møbler").parent(true).level(1).icon("fa fa-home")
                .build();
        ...
        Category kitchenmachine = Category.builder().level(2).name("Kjøkkenmaskin").parentName(kitchen.getName())
                .child(true).build();
        ...
        Category handball = Category.builder().level(3).name("Håndball").child(true).parentName(ballSport.getName())
                .build();
        ...
        Category divingequipment = Category.builder().level(3).name("Dykkerutstyr").child(true)
                .parentName(waterSport.getName()).build();
        Category wetsuit = Category.builder().level(3).name("Våtdrakt").child(true).parentName(waterSport.getName())
                .build();
        ...
        Category skoyteski = Category.builder().level(3).name("Skøyteski").child(true).parentName(skis.getName())
                .build();
        ...
        Category kajakk = Category.builder().level(3).name("Kajakk").child(true).parentName(outdoorlife.getName())
                .build();
        Category clohting = Category.builder().level(3).name("Ytterklær").child(true).parentName(outdoorlife.getName())
                .build();
        ...
        // Other instrument
        Category blow = Category.builder().level(2).name("Blåseinstrument").child(true)
        ...
        Category trillebor = Category.builder().level(3).child(true).name("Trillebår").parentName(hage.getName())
                .build();
        ...
        Ad tux = Ad.builder().title("Leier ut tux").description("1000 kr pr kveld").rental(true)
                ...
                .build();
        Ad pc = Ad.builder().title("Leier ut Pc").description("Lån en lenovo PC, funker bra til skole eller jobb.")
        ...
        Ad newHammer = Ad.builder().title("Ny Hammer").description("Leier ut en ny hammer").rental(true).user(user5)
                ...
                .build();
        Ad matte = Ad.builder().title("Skolebøker Matematikk 1").user(user1)
        ...
        Ad tent = Ad.builder().title("Lavvo").description("Lavvo med plass til 8").rental(true).durationType(AdType.DAY)
                .price(800).created(LocalDate.now()).lat(63.436265).lng(10.625622).streetAddress("Ålivegen 6C")
        ...
        Ad kjokkenmaskin = Ad.builder()
                .description("Brødbakemaskin leies ut. Man kan bake alt fra pizza deig til dansk rugbrød.")
                .title("Bosch Brødbakemaskin").durationType(AdType.WEEK).price(350).postalCode(7054)
                .streetAddress("Væretrøa 160").city("Ranheim").rental(true).user(user4).category(kitchenmachine)
        ...
        Ad koleboks = Ad.builder().title("Kjøleboks leies ut").description("Kjøleboks leies ut til arrangementer")
                .durationType(AdType.DAY).streetAddress("Fjordvegen 2").postalCode(9999).city("Båtsfjord").price(100)
        ...
        Ad bil = Ad.builder().title("Bil leies ut").description("Leier ut en volvo 240 til 200kr dagen")
                ...
                .category(car).rental(true).city("Stjørdal").created(LocalDate.now()).lat(63.468724).lng(10.928546)
                .build();
        Ad bot = Ad.builder().title("Båt til utleie").streetAddress("Illsvikøra 11")
                .description("Leier ut seilbåten min i skansen for dagsturer til erfarne seilere")
        ...
        Ad moped = Ad.builder().title("Moped til utleie")
                .description("Leier ut mopeden min til daglig bruk, da den ikke brukes så mye.")
                .durationType(AdType.DAY).postalCode(7014).city("Trondheim").streetAddress("Øvre Kristianstens gate 2B")
        ...
        Ad tilhenger = Ad.builder().title("Tilhenger")
                .description("Stor tilhenger til utleie, funker for møbler og store gjenstander.")
                .durationType(AdType.DAY).postalCode(7051).price(350).rental(true).streetAddress("Øvre Bergsvingen 3")
        ...
        Ad gravemaskin = Ad.builder().title("Gravemaskin til utleie")
                .description("Leier ut en Ultimate digger 2000 fra CAT.Leier må hente selv.").durationType(AdType.DAY)
        ...
        Ad elsykker = Ad.builder().title("Min fine rosa elsykkel!")
                .description("Vanskelig å komme seg hjem fra byen i helgene? Lån denne kjærra her!")
        ...
        Ad handyball = Ad.builder().title("Håndballsko").description("Låner ut håndballskoene mine i str 38")
