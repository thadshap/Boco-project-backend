...
public class DataLoader implements ApplicationRunner {
    ...
    public DataLoader(UserRepository userRepository, AdRepository adRepository,
        ...
        public void run(ApplicationArguments args) throws IOException {
            ...
            rental = Rental.builder().ad(klovn).owner(user2).borrower(user8).price(1000).active(false).deadline(LocalDate.now().minusDays(95)).rentTo(LocalDate.now().minusDays(85)).rentFrom(LocalDate.now().minusDays(94)).dateOfRental(LocalDate.now().minusDays(105)).build();
            rentalRepository.save(rental);
            rental = Rental.builder().ad(matte).owner(user6).borrower(user9).price(100).active(false).deadline(LocalDate.now().minusDays(100)).rentTo(LocalDate.now().minusDays(90)).rentFrom(LocalDate.now().minusDays(99)).dateOfRental(LocalDate.now().minusDays(110)).build();
            rentalRepository.save(rental);
