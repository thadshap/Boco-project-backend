    ...
    public DataLoader(UserRepository userRepository, AdRepository adRepository,
        ...
        public void run(ApplicationArguments args) throws IOException {
            ...
            Ad borremaskin = Ad.builder().title("Borre-maskin").description("Leier ut en kraftig borremaskin. Pent brukt og fungerer som den skal.").
                    rental(true).user(user5).durationType(AdType.MONTH).duration(2).price(50).created(LocalDate.now()).lat(63.2).lng(10.4).streetAddress("Valgrindvegen 5A").postalCode(7031).city("Trondheim").user(user1).category(verktoy).build();
